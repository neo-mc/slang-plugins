...
mc->editor_map_key_to_func("GrowInteger", "ctrl-alt-a", "grow_shrink_int__grow_int");
mc->editor_map_key_to_func("ShrinkInteger", "ctrl-alt-x", "grow_shrink_int__shrink_int");
